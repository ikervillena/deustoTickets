...
public class JsonResponseParser {
    ...
    public static ArrayList<Evento> getEventos(String respuesta) throws JSONException {
        ...
        for (int i = 0; i < data.length(); i++) {
            ...
            JSONObject espacioJson = atributos.getJSONObject("espacio").getJSONObject("data")
    ...
    public static ArrayList<Integer> getIDPrecios(String respuesta) throws JSONException {
        ...
        for (int i = 0; i < data.length(); i++) {
            int id = data.getJSONObject(i).getJSONObject("attributes").getJSONObject("cliente").getJSONObject("data")
                    .getInt("id");
            if (id == 4) {
    ...
    public static ArrayList<Precio> getPreciosEvento(Evento evento, ArrayList<Integer> idPrecios, String respuesta)
